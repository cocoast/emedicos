...
<button type="button" data-path="{{route('permiso.create') }}" class="btn btn-primary btn-sm openBtn">
                    Agregar Permisos</button>

<table id="permisostable" class="table table-striped table-hover mt-4" style="width:100%">
	<thead>
	<tr>
      <th scope="col">#</th>
      <th scope="col">Permiso</th>
      <th scope="col"> Guard?</th>
      <th scope="col">@can('permiso.destroy')Eliminar @endcan</th>
	</tr>
	</thead>
	<tbody>
